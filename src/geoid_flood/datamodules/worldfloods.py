...
from geoid_flood.datasets import WorldFloodsDataset
...
class WorldFloodsDataModule(NonGeoDataModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize the DataModule for the WorldFloods dataset for TerraTorch Framework.
        ...
        Args:
            ...
            input_sources: data sources of the input data (Sentinel-1, Sentinel-2).
            output_sources: data sources of the output data (Sentinel-1, Sentinel-2).
            dataset_bands: expected bands when reading a tile
            output_bands: outputted bands by the dataset class.
            max_cc: maximum cloud cover/invalid values accepted. Images with a
                    cloud cover higher than this value will be filtered out.
            max_diff: maximum difference between the two dates of the two sources.
            min_water: minimum water number of water pixels.
            use_metadata: Whether to use metadata (coords and acquistion time).
        ...
        """
        super().__init__(WorldFloodsDataset, batch_size, num_workers, **kwargs)
