...
from geoid_flood.datasets import Sen1Floods11Dataset
...
class Sen1Floods11DataModule(NonGeoDataModule):
    ...
    def __init__(
        ...
        input_sources: tuple = ("S1RTC",),
        output_sources: tuple = ("S1RTC",),
        ...
        **kwargs,
        ...
        """
        Initialize the DataModule for the Sen1Floods11 dataset for TerraTorch Framework.
        ...
        Args:
            ...
            input_sources: data sources of the input data (e.g. S1RTC, S2Hand).
            output_sources: data sources of the output data.
            ...
            min_water: minimum proportion of water pixels in a tile.
        ...
        """
        super().__init__(Sen1Floods11Dataset, batch_size, num_workers, **kwargs)
